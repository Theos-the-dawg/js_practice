...
function UserObject(){
let Users = [{"name":"Alice","isActive":true}, {"name":"Bob","isActive":false},{"name":"Charlie","isActive":true}];
...
function StockLevel() {
    let product = [{"item":"Pen","quantity":5},{"item":"Notebook","quantity":0},{"item":"Pencil","quantity":2}];
    for(){}
}
